...
insert into hd_user_question (userid,title, type,score,createtime) values (1,'你选择网购的主要原因02?',0,10,now());
...
insert into hd_user_question (userid,title, type,score,createtime) values (1,'你选择网购的主要原因05?',0,10,now());
insert into hd_user_question (userid,title, type,score,createtime) values (1,'你选择网购的主要原因06?',0,10,now());
