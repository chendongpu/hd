...
public class UserAddressController {
    ...
    public Object createUserAddress( @Valid @RequestBody NewUserAddressRequest newUserAddressReq) {
        ...
        if (userAddressOption.isPresent()) {
            jsonObject.put("message", "该手机号的地址已存在");
            return jsonObject;
        } else {
            ...
            return userAddressService.createUserAddress(newUserAddress);
        }
    }
    ...
    public Object removeUserAddress(@RequestParam  Long id) {
    ...
    public Object updateUserAddress(@Valid @RequestBody NewUserAddressRequest newUserAddressReq){
    ...
    public Object allUserAddress(Integer limit,Integer page){
